...
- Issue #6、#7、#8、#9、#10、#21和#22已合并，阶段0后端基础设施、数据、合同、异步可靠性、文本模型网关、身份授权以及课时与分支配置进入`main`。
...
- [Issue #23：实现文件资产、不可变版本和教材解析记录](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/issues/23)
...
阶段1后端轨道已完成身份授权和课时/分支基座；下一门禁是#23文件资产与解析版本。#24内容/工作流运行时保持`status:ready`，完整依赖、测试和回退要求以父Issue #19为准。
