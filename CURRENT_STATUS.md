...
- [Issue #4](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/issues/4)的生产前端源码已由[PR #111](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/pull/111)合并进入`main`，#179至#182已经关闭；[Issue #11](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/issues/11)与Draft [PR #208](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/pull/208)现在是唯一真实API联调现场。在#11完成真实Provider、PostgreSQL与刷新恢复验收前，仍不得把Mock闭环、交付ZIP或本地分支描述为生产教师MVP完成。
...
- [Issue #4](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/issues/4)与[PR #111](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/pull/111)：生产前端源码与#179至#182整改已经合并，继续作为父任务追踪#11的真实联调出口。
...
- [Issue #11](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/issues/11)与Draft [PR #208](https://github.com/DOIT-Ben/ShanHaiEdu-kejian-system/pull/208)：当前P0联调任务；只完成教材与物理页码选择、真实`newapi/deepseek`、课时划分、十二部分教案、三类九套、编辑/局部重生成、批准/唯一选择和刷新恢复，不得由Mock替代。

## 当前阻塞

- 阶段1整体产品出口仍缺少生产前端的真实API联调；后端轨道通过不代表完整阶段1产品完成。
- 生产前端源码已经进入`main`，#11/PR #208现独占真实页面与active Runtime API联调；当前阻塞是逐项关闭页面可复现的正式接口缺口并完成真实Provider、PostgreSQL和刷新恢复验收，不再等待或竞争第二个前端现场。
...
1. #4/PR #111已同步最新`main`、关闭最终浏览器与治理门禁并合并生产前端源码。
