...
from apps.api.intro_options.prepare_service import IntroOptionGenerationPreparationService
...
def prepare_intro_option_generation(
    ...
    with session.begin():
        data = IntroOptionGenerationPreparationService(
            session,
            actor,
    ...
    return NodeRunEnvelope(
        data=NodeRunRead.model_validate(data),
