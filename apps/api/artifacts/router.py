...
from apps.api.artifacts.lesson_plan_review import open_lesson_plan_approval_gate
from apps.api.artifacts.models import Artifact
from apps.api.artifacts.presentation import (
    serialize_approval,
    serialize_artifact,
    serialize_draft,
    serialize_version,
...
def review_artifact_version(
    ...
    def command() -> CommandResult:
        open_lesson_plan_approval_gate(session, actor, artifact_version_id, payload.action)
