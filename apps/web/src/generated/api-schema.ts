...
export interface components {
  schemas: {
    ...
    /** @enum {string} */
    GenerationJobStatus:
      "created" | "queued" | "running" | "succeeded" | "failed" | "cancel_requested" | "cancelled";
    GenerationJob: {
      /** Format: uuid */
      id: string;
      /** Format: uuid */
    ...
    CreateCreationBatchRequest:
      | components["schemas"]["ProjectCreateCreationBatchRequest"]
      | components["schemas"]["StandaloneCreateCreationBatchRequest"];
    CompatibleCreateCreationBatchRequest:
      | components["schemas"]["LegacyCreateCreationBatchRequest"]
      | components["schemas"]["CreateCreationBatchRequest"];
    /** @deprecated */
    ...
    CompatibleGenerateCreationBatchRequest:
      | components["schemas"]["LegacyGenerateCreationBatchRequest"]
      | components["schemas"]["GenerateCreationBatchRequest"];
    ProjectCreationItem: {
      /** Format: uuid */
      id: string;
      item_key: string;
    ...
    CreationBatch:
      | components["schemas"]["ProjectCreationBatch"]
      | components["schemas"]["StandaloneCreationBatch"];
    ...
    CreationBatchEnvelope:
      | components["schemas"]["LegacyCreationBatchEnvelope"]
      | components["schemas"]["CurrentCreationBatchEnvelope"];
    /**
    ...
    SaveAdoptionToProjectRequest:
      | components["schemas"]["ProjectSourceSaveRequest"]
      | components["schemas"]["StandaloneSourceSaveRequest"];
    ...
    option: {
      ...
      /** @enum {unknown} */
      suggested_medium:
        "video" | "image" | "physical_object" | "question" | "performance" | "mixed";
