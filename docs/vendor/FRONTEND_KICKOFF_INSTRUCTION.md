...
>
> 这是全新前端，不是在旧页面上换皮。产品定位是“教师创作台”，不是臃肿的流程控制台。首页突出品牌、开始创作和真实成果感；项目内突出当前课时作品和下一步；通用图片、视频、PPT创作中心独立存在，同时可以导入项目创作包并把选中结果保存回指定项目。
>
...
>
> 节点状态、后台任务状态、候选审核状态、批准状态和保存状态分别建模。SSE必须支持心跳、`Last-Event-ID`和重连；409冲突、部分成功、暂停、取消、失败重试和过期状态必须有完整界面。
>
